...
# color_green = ['forestgreen', 'limegreen', 'green', 'lime', 'springgreen']
color_1 = ['forestgreen', 'limegreen', 'green', 'lime']
color_2 = ['darkcyan', 'cyan', 'darkturquoise', 'deepskyblue','cornflowerblue']
color_3 = ['blue', 'daikblue', 'navy', 'mediumblue']
color_4 = ['yellow', 'gold', 'dark_orange', 'orange']
...
query_feature_tsne = np.reshape(query_feature_tsne,(-1,24,2))


for i in range(24):

    plt.scatter(query_feature_tsne[:,i,0], query_feature_tsne[:,i,1], marker='o')
